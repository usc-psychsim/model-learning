...
from model_learning import Trajectory, TeamModelDistTrajectory, State, SelectionType
from model_learning.trajectory import generate_trajectories_with_inference, copy_world, generate_trajectory, \
...
def _generate_trajectories(agent: Agent,
                           initial_state: State,
                           trajectory_length: int,
                           exact: bool,
